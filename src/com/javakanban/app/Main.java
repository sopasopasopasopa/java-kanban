...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        task1 = new Task(taskId1, task1.getNameTask(), task1.getDescriptionTask(), Duration.ZERO, LocalDateTime.now());

        Task task2 = new Task("task2", "task number two");
        final int taskId2 = task1.getTaskId();
        task2 = new Task(taskId2, task2.getNameTask(), task2.getDescriptionTask(), Duration.ZERO, LocalDateTime.now());

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        Epic epic1 = new Epic("epic1", "epic number one");
        final int epicId1 = epic1.getTaskId();
        epic1 = new Epic(epicId1, epic1.getNameTask(), epic1.getDescriptionTask(), Duration.ZERO, LocalDateTime.now());

        Epic epic2 = new Epic("epic2", "epic number two");
        final int epicId2 = epic1.getTaskId();
        epic2 = new Epic(epicId2, epic2.getNameTask(), epic2.getDescriptionTask(), Duration.ZERO, LocalDateTime.now());

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

        Subtask subtask1 = new Subtask("subtask1", "subtask number one", epic1.getTaskId());
        final int subtaskId1 = subtask1.getTaskId();
        subtask1 = new Subtask(subtaskId1, subtask1.getNameTask(), subtask1.getDescriptionTask(), Duration.ZERO, LocalDateTime.now(), epic1.getTaskId());

        Subtask subtask2 = new Subtask("subtask2", "subtask number two", epic1.getTaskId());
        final int subtaskId2 = subtask2.getTaskId();
        subtask2 = new Subtask(subtaskId2, subtask2.getNameTask(), subtask2.getDescriptionTask(), Duration.ZERO, LocalDateTime.now(), epic1.getTaskId());

        Subtask subtask3 = new Subtask("subtask3", "subtask number three", epic2.getTaskId());
        final int subtaskId3 =subtask3.getTaskId();
        subtask3 = new Subtask(subtaskId3, subtask3.getNameTask(), subtask3.getDescriptionTask(), Duration.ZERO, LocalDateTime.now(), epic2.getTaskId());
